...
my $min_iterations =
    Math::Business::BlackScholesMerton::Binaries::get_min_iterations_pelsser_1997(
...
throws_ok {
    $min_iterations =
        Math::Business::BlackScholesMerton::Binaries::_get_min_iterations_ot_up_ko_down_pelsser_1997(
        $S, $barrier_u, $barrier_l, $t, $r, $r - $q, $sigma, 0);
...
$Math::Business::BlackScholesMerton::Binaries::MIN_ITERATIONS_UPORDOWN_PELSSER_1997 =
  -1;
$Math::Business::BlackScholesMerton::Binaries::MAX_ITERATIONS_UPORDOWN_PELSSER_1997 =
  -1;
$min_iterations =
    Math::Business::BlackScholesMerton::Binaries::_get_min_iterations_ot_up_ko_down_pelsser_1997(
    $S, $barrier_u, $barrier_l, $t, $r, $r - $q, $sigma, 0, 1);
