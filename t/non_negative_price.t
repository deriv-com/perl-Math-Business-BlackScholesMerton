...
my $price_abko = Math::Business::BlackScholesMerton::Binaries::americanknockout(
       $S, $H2, $H1, $K, $tiy, $sigma, $mu, $type
);
ok ($price_abko == 0, 'return 0 for negative values');

$tiy  = 1;

$price_abko = Math::Business::BlackScholesMerton::Binaries::americanknockout(
       $S, $H2, $H1, $K, $tiy, $sigma, $mu, $type
);
