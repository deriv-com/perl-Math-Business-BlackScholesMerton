...
iabbr psub3 :r ~/work/lib/templates/perl/perl_sub3.pl
iabbr psub2 :r ~/work/lib/templates/perl/perl_sub2.pl
iabbr psub :r ~/work/lib/templates/perl/perl_sub3.pl
...
iabbr hdwr :r ~/work/lib/templates/html/div_wrapper.html
iabbr tel [% ELSE %]
iabbr te [% END %]
iabbr cd console.debug(
...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/vim-colors-solarized,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set shiftround
set shiftwidth=4
...
silent only
cd /apps/perl-math-business-blackscholes-binaries
